 ...
 * application.
 */
Ext.define('app.view.customer.OrderPlaceController', {
						    ...
						    buttons: [ { 
						  		...
						  		console.log('go to my orders');
											Ext.getCmp('customermain')
													.setActiveTab(0);
											Ext.getCmp('myOder').store.reload();
									  		myMsg.destroy();
						  	}
						  }, { 
						  		id: 'no', 
...
/*						Ext.Msg.show({
	...
	onImgDispClick : function() {
		...
		// }
		Ext.getCmp('customermain').setActiveTab(2);
		// alert('You clicked the button!');
	},
	onImgUploadClick : function() {
		/*
		 * var tab = new Ext.TabPanel({ // renderTo:"test",
		 * 
		 * });
		 */
